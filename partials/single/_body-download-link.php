            ...
            foreach ($quality_data as $index => $quality) {
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingQuality<?php echo $index; ?>">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseQuality<?php echo $index; ?>" aria-expanded="false" aria-controls="collapseQuality<?php echo $index; ?>">
                            کیفیت: <?php echo esc_html($quality['name']); ?>
                        </button>
                    </h2>
                    <div id="collapseQuality<?php echo $index; ?>" class="accordion-collapse collapse" aria-labelledby="headingQuality<?php echo $index; ?>" data-bs-parent="#qualityAccordion">
            ...
            foreach ($season_data as $season_index => $season) {
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingSeason<?php echo $season_index; ?>">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeason<?php echo $season_index; ?>" aria-expanded="false" aria-controls="collapseSeason<?php echo $season_index; ?>">
                            فصل <?php echo $season_index + 1; ?>
                        </button>
                    </h2>
                    <div id="collapseSeason<?php echo $season_index; ?>" class="accordion-collapse collapse" aria-labelledby="headingSeason<?php echo $season_index; ?>" data-bs-parent="#seasonAccordion">
                        <div class="accordion-body">
                            <div class="accordion" id="qualityAccordion<?php echo $season_index; ?>">
                                ...
                                if (!empty($season['qualities'])) {
                                    foreach ($season['qualities'] as $quality_index => $quality) {
                                        ?>
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingQuality<?php echo $season_index; ?>_<?php echo $quality_index; ?>">
                                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseQuality<?php echo $season_index; ?>_<?php echo $quality_index; ?>" aria-expanded="false" aria-controls="collapseQuality<?php echo $season_index; ?>_<?php echo $quality_index; ?>">
                                                    کیفیت: <?php echo esc_html($quality['name']); ?>
                                                </button>
                                            </h2>
                                            <div id="collapseQuality<?php echo $season_index; ?>_<?php echo $quality_index; ?>" class="accordion-collapse collapse" aria-labelledby="headingQuality<?php echo $season_index; ?>_<?php echo $quality_index; ?>" data-bs-parent="#qualityAccordion<?php echo $season_index; ?>">
                                                <div class="accordion-body">
                                                    <?php
                                                    if (!empty($quality['episodes'])) {
                                                        echo '<ul>';
