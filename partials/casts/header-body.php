            ...
            <div class="left-side d-flex align-items-center">
                <div class="profession">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="change-post-type">
                            <li><a class="dropdown-item" id="all" href="?profession=">همه</a></li>
                            <li><a class="dropdown-item" id="actor" href="?profession=actor">بازیگر</a></li>
                            <li><a class="dropdown-item" id="female" href="?profession=director">کارگردان</a></li>
                            <li><a class="dropdown-item" id="female" href="?profession=writer">نویسنده</a></li>
                        </ul>
                    </div>
                </div>
                <div class="order-by">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="change-post-type">
                            <li><a class="dropdown-item" id="all" href="?gender=">همه</a></li>
                            <li><a class="dropdown-item" id="female" href="?gender=female">زن</a></li>
                            <li><a class="dropdown-item" id="male" href="?gender=male">مرد</a></li>
                        </ul>
