            ...
            <div class="genre">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="?profession=">همه</a></li>
                  <li><a class="dropdown-item" href="?profession=actor">بازیگر</a></li>
                  <li><a class="dropdown-item" href="?profession=director">کارگردان</a></li>
                  <li><a class="dropdown-item" href="?profession=writer">نویسنده</a></li>
                </ul>
              </div>
            </div>
            <div class="order-by">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="?gender=">همه</a></li>
                  <li><a class="dropdown-item" href="?gender=male">مرد</a></li>
                  <li><a class="dropdown-item" href="?gender=female">زن</a></li>
                </ul>
              </div>
            </div>
          </div>
...
<!-- ============================ start body ============================ -->
<div class="container wrapper-artist-container  ">
    <div class="row" >
    <?php get_template_part('loop/casts/wrapper-artist', 'wrapper-artist') ?>
    </div>
</div>
<!-- ============================ end body ============================ -->