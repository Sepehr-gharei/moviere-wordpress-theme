                ...
                <div class="order-by">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" id="all" href="?order=">همه</a></li>
                            <li><a class="dropdown-item" id="all" href="?order=new">جدیدترین</a></li>
                            <li><a class="dropdown-item" id="all" href="?order=old">قدیمی ترین</a></li>
                            <li><a class="dropdown-item" id="all" href="?order=rate">امتیاز imdb</a></li>
                        </ul>
                    </div>
                </div>
